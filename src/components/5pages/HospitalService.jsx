              ...
              >
                {(() => {
                  if (isAllHospitalResourceDataLoaded === true) {
                    ...
                    {
                      /* console.log(allHospitalResourceData[0].hospitalDistrict);
                console.log(allHospitalResourceData[0].hospitalEmail);
                console.log(allHospitalResourceData[0].hospitalName);
                console.log(allHospitalResourceData[0].hotpitalPhNo);
                console.log(allHospitalResourceData[0].patientAddress);
                console.log(allHospitalResourceData[0].patientDoge);
                console.log(allHospitalResourceData[0].patientId);
                console.log(allHospitalResourceData[0].patientName); */
                    }
                    return (
                      <>
                        {(() => {
